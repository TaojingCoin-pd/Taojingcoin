...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tjcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Tjcointools.com", "dnsseed.Tjcointools.com"},
    {"Tjcoinpool.org", "dnsseed.Tjcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Tjcointools.com", "testnet-seed.Tjcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tjcoin is probably already running."), addrBind.ToString().c_str());
        else
